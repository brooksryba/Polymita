...
class PayPal:
    ...
    def create_order(self, amount):
        ...
        url = f"{self.baseURL}/v2/checkout/orders"
    ...
    def capture_payment(self, order_id):
        access_token = self.generate_access_token()
        url = f"{self.baseURL}/v2/checkout/orders/{order_id}/capture"
    ...
    def generate_access_token(self):
        ...
        response = requests.post(f"{self.baseURL}/v1/oauth2/token", headers={
